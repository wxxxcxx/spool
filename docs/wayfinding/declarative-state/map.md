...
- [跨重启恢复的入口票](issues/25-cross-restart-recovery.md) — 恢复地图的入口：身份连续性证据、恢复域与顺序、候选 vs 自动绑定、停机冲突、版本策略、呈现影响。用户 2026-09-15 已按票中七项倾向裁决；入口与所有者、Space 归属、焦点记忆三个域已实施（26/28/29 号票）。
