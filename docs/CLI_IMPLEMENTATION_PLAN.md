...
| --- | --- | --- |
| Window / Spool | identity; desired/presented/observed geometry; retained layout membership; availability, visibility, known motion/migration/blockers | `geometry`, `layout`, `state`, or their documented leaf paths |
